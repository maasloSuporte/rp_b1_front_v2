...
const base = "inline-flex items-center justify-center font-semibold rounded-xl transition-all duration-200 min-h-[2.75rem] px-6 py-3 disabled:opacity-50 disabled:cursor-not-allowed";
const variants = {
  primary: "bg-primary text-white shadow-sm hover:shadow-md hover:bg-primary/90 active:scale-[0.98]",
  secondary: "bg-white text-text-primary border-2 border-border-form hover:bg-background hover:border-text-secondary/30 active:scale-[0.98]"
};
function FormButton({
  variant = "primary",
  children,

...
import { u as useNotificationStore, f as frequencyService, p as projectsService, d as devicesService, b as priorityService, s as scheduleService } from "./server-build-DPaCijSr.js";
            ...
            Controller,
            {
              ...
              render: ({ field }) => /* @__PURE__ */ jsxs(
                FormSelect,
                {
                  ...
                  ref: field.ref,
                  children: [
                    /* @__PURE__ */ jsx("option", { value: 0, children: t("pages.schedule.noneOptional") }),

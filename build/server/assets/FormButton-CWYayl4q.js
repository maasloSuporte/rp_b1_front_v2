...
const FormSelect = React.forwardRef(function FormSelect2({
  ...
  const handleChange = (newValue) => {
    let valueToSet = "";
    if (newValue != null && typeof newValue === "object" && "target" in newValue && newValue.target != null) {
      valueToSet = newValue.target.value;
    } else if (newValue !== void 0 && newValue !== null && (typeof newValue === "string" || typeof newValue === "number")) {
      valueToSet = newValue;
    }
    const event = {

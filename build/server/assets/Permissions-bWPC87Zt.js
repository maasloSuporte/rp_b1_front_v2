...
import { a as api, u as useNotificationStore, r as rolesService } from "./server-build-BQl7k4Fv.js";
import "stream";
...
function Permissions() {
  ...
  const groupPermissionsByResource = (perms) => {
    ...
    for (const perm of perms) {
      ...
      grouped[resource].actions[mappedAction] = perm.id;
    }
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit(onSubmit), children: [
    /* @__PURE__ */ jsxs("div", { className: "permissions-container", children: [
      /* @__PURE__ */ jsx("header", { className: "header", children: /* @__PURE__ */ jsx("h1", { children: "Permissions" }) }),
      /* @__PURE__ */ jsx("section", { className: "permissions-section", children: /* @__PURE__ */ jsxs("div", { className: "input-group", children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "user-search", children: "Name *" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
        ...
        errors.roleName && /* @__PURE__ */ jsx("span", { className: "error-message", children: errors.roleName.type === "required" ? "Role name is required." : errors.roleName.type === "minLength" ? "Role must be at least 5 characters long." : errors.roleName.message })
      ] }) }),
      /* @__PURE__ */ jsx("section", { className: "table-section", children: /* @__PURE__ */ jsx("div", { className: "permissions-card", children: /* @__PURE__ */ jsxs("table", { className: "permissions-table", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
          /* @__PURE__ */ jsx("th", { style: { textAlign: "left" }, children: "Permissions" }),
        ...
        /* @__PURE__ */ jsx("tbody", { children: groupedPermissions.map((group, index) => /* @__PURE__ */ jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsx("td", { children: group.actions.view && /* @__PURE__ */ jsx(
            "input",
            {
              type: "checkbox",
          ...
          /* @__PURE__ */ jsx("td", { children: group.actions.create && /* @__PURE__ */ jsx(
            "input",
            {
              type: "checkbox",
              className: "permission-radio",
          ...
          /* @__PURE__ */ jsx("td", { children: group.actions.edit && /* @__PURE__ */ jsx(
            "input",
            {
              type: "checkbox",
              className: "permission-radio",
          ...
          /* @__PURE__ */ jsx("td", { children: group.actions.delete && /* @__PURE__ */ jsx(
            "input",
            {
              type: "checkbox",
              className: "permission-radio",
      ...
      /* @__PURE__ */ jsxs("div", { className: "action-buttons", children: [
        /* @__PURE__ */ jsx("button", { type: "button", className: "cancel-btn", onClick: cancelPermission, children: "Cancel" }),
        /* @__PURE__ */ jsx("button", { type: "submit", className: "create-btn", disabled: !isValid, children: isEditMode ? "Edit" : "Create" })
      ] })
    ] }),

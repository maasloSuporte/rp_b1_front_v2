    ...
    return (
      <div className="p-5 min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">{t('pages.jobDetails.loading')}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mb-6">
        ...
        <h1 className="text-4xl font-semibold text-text-primary">{t('pages.jobDetails.title')}</h1>
      </div>

      <section className="bg-white rounded-lg shadow-card p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.name')}</label>
            <p className="text-gray-900">{job.name || '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.hostname')}</label>
            <p className="text-gray-900">{job.hostname || '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.projectName')}</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.priority')}</label>
            <p className="text-gray-900">{job.priority || '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.packageVersion')}</label>
            <p className="text-gray-900">{job.packageVersion || '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.startedAt')}</label>
            <p className="text-gray-900">{job.started ? new Date(job.started).toLocaleString() : '-'}</p>
          </div>

          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('pages.jobDetails.endedAt')}</label>
